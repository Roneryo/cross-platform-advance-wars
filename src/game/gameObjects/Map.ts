...
export class Map extends Phaser.Tilemaps.MapData {
  ...
  createLevelWithTileMap(scene: Phaser.Scene): void {
    ...
    // console.log(map);
    const dessert_tilesets: Phaser.Tilemaps.Tileset = this.grid.addTilesetImage(
      "DESSERT2",
      "dessert-tiles"
    );
    const sea_tilesets: Phaser.Tilemaps.Tileset = this.grid.addTilesetImage(
      "MAR2",
      "sea-tiles"
    );
    ...
    const Trees = this.grid.createLayer(2, dessert_tilesets, 0, 0);
    const Above = this.grid.createLayer(3, dessert_tilesets, 0, 0);
    const Below = this.grid.createLayer(4, dessert_tilesets, 0, 0);
    const Sea = this.grid.createLayer(5, sea_tilesets, 0, 0);
    const World = this.grid.createLayer(6, dessert_tilesets, 0, 0);
    Sand.setScale(2);
    ...
    Sea.setScale(2);
    World.setScale(2);
    this.makeTileAnimations(dessert_tilesets, this.grid);
